...
<script lang="ts" setup>
    ...
    const stellarPk = ref<string>();
    const stellarSk = ref<string>();

    const init = async () => {
        const stellarKp: StellarKeyPair = getStellarKeyPairFromDerivedSeed(derivedSeed.value);

        stellarPk.value = stellarKp.publicKey();
        stellarSk.value = stellarKp.secret();
